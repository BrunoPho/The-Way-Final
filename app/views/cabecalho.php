      ...
      <div class="carousel-inner">
        <div class="item active" style="background-image: url(assets/images/slider/1.jpg)">
          <div class="caption">
            ...
            <a data-scroll class="btn btn-start animated fadeInUpBig" href="/menuDeCadastros.html">Cadastre-se</a>
          </div>
        </div>
        ...
        <div class="item" style="background-image: url(assets/images/slider/3.jpg)">
          <div class="caption">
            ...
            <a data-scroll class="btn btn-start animated fadeInUpBig" href="/loginT.html">Entrar</a>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">                 
            ...
            <li class="scroll"><a href="app/view/ajuda.html">  Ajuda     </a></li>
            <li class="scroll"><a href="app/view/loginT.html"> Entrar    </a></li>
          </ul>
        </div>
      </div>
